...
var _configCrdYaml = []byte(`apiVersion: apiextensions.k8s.io/v1beta1
...
func configCrdYamlBytes() ([]byte, error) {
	return _configCrdYaml, nil
}

func configCrdYaml() (*asset, error) {
	bytes, err := configCrdYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "config/crd.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"config": {nil, map[string]*bintree{
		...
		"crd.yaml":             {configCrdYaml, map[string]*bintree{}},
